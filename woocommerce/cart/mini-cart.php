	...
	<div class="widget_shopping_cart_content">
							...
							<div class="info_box">
								...
								<div class="actions_box">
									<div class="product-quantity product-quantity-picker">
										...
										echo apply_filters('woocommerce_cart_item_quantity', '<button type="button" class="increment">
										...
										</button>', $cart_item_key, $cart_item);
										?>
									</div>
		...
		<div class="button_box">
			<a
				...
				class="primary_button" <?= (WC()->cart && WC()->cart->is_empty()) ? 'disabled' : '' ?>><?php _e('Proceed to checkout', 'woocommerce-mini-cart'); ?></a>
		</div>
	</div>
